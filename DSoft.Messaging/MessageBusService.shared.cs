...
namespace DSoft.MessageBus
{
    internal class MessageBusService : IMessageBusService
    {
        ...
        /// </summary>
        public bool RunPostOnSeperateTask { get; set; } = false;

        #region Fields
        private Lazy<MessageBusEventHandlerCollection> _eventHandlers = new Lazy<MessageBusEventHandlerCollection>(() => new MessageBusEventHandlerCollection());
        private Lazy<LogListernersCollection> _logListeners = new Lazy<LogListernersCollection>(() => new LogListernersCollection());
        #endregion
        ...
        private MessageBusEventHandlerCollection EventHandlers => _eventHandlers.Value;
        ...
        /// </value>
        private LogListernersCollection LogListeners => _logListeners.Value;
        #endregion
        ...
        private void PostInternal(MessageBusEvent busEvent)
        {
        ...
        public void Log(string title, string message = null, LogSeverity severity = LogSeverity.Notification) => Log(Channels.All, title, message);
        ...
        private void LogInternal(string channelName, string title, string message = null, LogSeverity severity = LogSeverity.Notification)
        {
